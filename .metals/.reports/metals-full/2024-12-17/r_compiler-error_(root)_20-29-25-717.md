file://<WORKSPACE>/src/main/scala/npc.scala
### java.lang.StringIndexOutOfBoundsException: offset 1250, count -5, length 1449
...
action parameters:
offset: 1261
uri: file://<WORKSPACE>/src/main/scala/npc.scala
text:
```scala
package npc
import chisel3._
...
java.base/java.lang.String.checkBoundsOffCount(String.java:4591)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.$anonfun$signatureHelp$1(ScalaPresentationCompiler.scala:394)
```
#### Short summary: 
